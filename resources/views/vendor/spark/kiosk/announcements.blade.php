                        ...
                        <tr class="reveal" v-for="announcement in announcements">
                            ...
                            <td class="td">
                                <div class="reveal-target text-right">
                                    <button class="btn-reset float-left" @click="editAnnouncement(announcement)">
                                        <svg class="icon-20 icon-sidenav " xmlns="http://www.w3.org/2000/svg ">
                                            <path fill="#6699cc" d="M12.3 3.7L0 16v4h4L16.3 7.7l-4-4zm1.4-1.4L16 0l4 4-2.3 2.3-4-4z"/>
                                        </svg>
                                    </button>

                                    <button class="btn-reset" @click="approveAnnouncementDelete(announcement)">
                                        <svg class="icon-20 icon-sidenav " xmlns="http://www.w3.org/2000/svg ">
                                            <path fill="#ff3333" d="M4 2l2-2h4l2 2h4v2H0V2h4zM1 6h14l-1 14H2L1 6zm5 2v10h1V8H6zm3 0v10h1V8H9z " />
                                        </svg>
                                    </button>
                                </div>
                            </td>
        ...
        <div class="modal" id="modal-delete-announcement" tabindex="-1" role="dialog">
            <div class="modal-dialog" v-if="deletingAnnouncement">
                <div class="modal-content">
                    ...
                    <!-- Modal Actions -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-dismiss="modal">{{__('No, Go Back')}}</button>
