...
<spark-team-settings :user="user" :team-id="{{ $team->id }}" inline-template>
    <div class="spark-screen container">
        <div class="row">
            ...
            <div class="col-md-6 spark-settings-tabs ">
                <div class="card border-info">
                  ...
                  18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                                            ...
                                            <span class="teamvertical">{{__('teams.team_profile')}}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="#membership" aria-controls="membership" role="tab" data-toggle="tab">
                                        ...
                                        <span class="teamvertical">{{__('Membership')}}</span>
                                    </a>
                                </li>
              ...
              0-1.2-.2.8-1 1.3-2.4 1.3-3.8s0-2.7-1-3.8l1-.2z " />
                                            ...
                                            <span class="teamvertical">{{__('teams.view_all_teams')}}</span>
                                        </a>
                                    </li>
                                @else
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/settings">
                                            ...
                                            <span class="teamvertical">{{__('Your Settings')}}</span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="col-md-6 spark-billing-tab">
                <div class="card border-success">
                    <div class="card-header bg-success">
                        <h3 class="nav-heading mb-0 text-white">
              ...
              2 5 0 4-3 7-7 7v-2c2.8 0 5-2.2 5-5 0-1.4-.6-2.6-1.5-3.5L12 5zM7 20l-4-4 4-4v8zM7 8V0l4 4-4 4z " />
                                            ...
                                            <span class="teamvertical">{{__('Subscription')}}</span>
                                        </a>
                                    </li>
              ...
              8h4v2H4v-2z " />
                                            ...
                                            <span class="teamvertical">{{__('Payment Method')}}</span>
                                        </a>
                                    </li>
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                                            ...
                                            <span class="teamvertical">{{__('Invoices')}}</span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
