...
<spark-navbar
    ...
    <nav class="navbar navbar-light navbar-expand-md navbar-spark">
        ...
        <!-- Sidebar toggle button-->
            <span>
                <a href="#" class="navbar-btn sidebar-toggle fa-2x" data-toggle="offcanvas" role="button"> <i class="fa fa-fw ti-menu"></i>
                </a>
            </span>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                ...
                <a @click="showNotifications" class="notification-pill">
                ...
                <ul class="navbar-nav ml-4">
                    <li class="nav-item dropdown">
                        <a href="#" class="d-block d-md-flex text-center nav-link dropdown-toggle text-white" id="dropdownMenuButton" data-toggle="dropdown"
